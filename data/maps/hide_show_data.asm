...
FuchsiaCityHS:
	db FUCHSIA_CITY, FUCHSIACITY_KABUTO,  HIDE
	db FUCHSIA_CITY, FUCHSIACITY_OMANYTE, HIDE
	db BLUES_HOUSE, BLUESHOUSE_TOWN_MAP,  SHOW ; reserved compatibility entry
LoreleisRoomHS:
...
BluesHouseHSCopy: ; unreferenced compatibility entries
	db BLUES_HOUSE, BLUESHOUSE_DAISY1,   SHOW
	db BLUES_HOUSE, BLUESHOUSE_DAISY2,   HIDE
	db $FF, $01, SHOW ; end
