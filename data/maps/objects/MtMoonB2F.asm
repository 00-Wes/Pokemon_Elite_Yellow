...
MtMoonB2F_Object:
	...
	object_event 13,  6, SPRITE_HELIX_FOSSIL, STAY, NONE, TEXT_MTMOONB2F_HELIX_FOSSIL
	object_event 25, 21, SPRITE_ITEM_BALL, STAY, DOWN, TEXT_MTMOONB2F_HP_UP, HP_UP
	object_event 29,  5, SPRITE_ITEM_BALL, STAY, DOWN, TEXT_MTMOONB2F_TM_MEGA_PUNCH, TM_MEGA_PUNCH
