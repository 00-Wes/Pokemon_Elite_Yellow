	...
	const_export FUCHSIACITY_KABUTO
...
FuchsiaCity_Object:
	...
	object_event  6,  5, SPRITE_KABUTO, STAY, NONE, TEXT_FUCHSIACITY_FOSSIL
	object_event  6,  5, SPRITE_OMANYTE, STAY, NONE, TEXT_FUCHSIACITY_FOSSIL2
